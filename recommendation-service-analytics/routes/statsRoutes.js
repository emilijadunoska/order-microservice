 ...
 *         content:
 *           application/json:
 *             example: {"lastCalledEndpoint": "/api/recommendations/popular"}
 */
 ...
 *         content:
 *           application/json:
 *             example: {"mostFrequentlyCalledEndpoint": "/api/recommendations/popular"}
 */
 ...
 *         content:
 *           application/json:
 *             example: [{"endpoint": "/api/recommendations/popular", "count": 5}]
 */
 ...
 *       content:
 *         application/json:
 *           example: {"calledService": "/api/recommendations/popular"}
 *     responses:
 *       200:
